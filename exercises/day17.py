# goal is to build a desktop gui program that gets feet and inches
# as input from user and outmputs results in meters
...
layout = [[label1,input1],[label2, input2],[convert_btn, results]]
